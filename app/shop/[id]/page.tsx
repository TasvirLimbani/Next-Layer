...
export default function ProductDetailPage() {
  ...
  const galleryImages = selectedImages.length
    ? selectedImages
    : resolveGalleryImages(
      product.variants?.[0]?.images,
      product.images || product.similar || []
  ...
  return (
    <main className="w-full bg-white">
      <div className="mx-auto w-full max-w-7xl px-4 py-5 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
        ...
        {/* Breadcrumb */}
        <div className="mb-4 text-xs text-gray-500 sm:mb-6 sm:text-sm">
          <Link
            href="/shop"
            className="transition hover:text-amber-700"
          >
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="relative min-w-0 lg:sticky lg:top-6 lg:self-start">
            {/*
              FIX: The gallery needs an explicit, non-zero sized box to render
              into on every viewport. Previously only the loading skeleton had
              `aspect-square`, so on mobile (and whenever the gallery component
              relies on its parent for height) the real image could collapse
              to 0px tall or render at the wrong size. Wrapping it in a fixed
    ...
    <div className="flex h-full w-full items-center justify-center text-sm text-gray-400">
      No image available
          ...
          <div className="min-w-0">
            ...
            {/* Title */}
            <h1 className="mb-4 text-xl font-normal leading-tight tracking-tight text-gray-900 sm:text-3xl lg:text-4xl">
              {product.name}
            </h1>

            {/* Price */}
            <div className="mb-6 flex flex-wrap items-center gap-3">
              <span className="text-xl font-normal tracking-wide text-gray-900 sm:text-3xl">
                Rs. {product.price.toFixed(2)} INR
              </span>
                      ...
                      return (
                        ...
                        >
                          <button
                            ...
                            className={`h-9 w-9 rounded-full border-2 transition sm:h-11 sm:w-11 ${isSelected
                              ? 'border-gray-900 ring-2 ring-gray-300'
                              : 'border-gray-300 hover:border-gray-500'
                              }`}
                            style={{
            ...
            <div className="mb-6">
              ...
              <div className="flex h-11 w-fit items-center overflow-hidden rounded-xl border border-gray-300 sm:h-12">
                <button
                  type="button"
                  onClick={() =>
                    setQuantity(
                  ...
                  disabled={!product.inStock}
                  className="flex h-full w-11 items-center justify-center text-lg text-gray-600 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 sm:w-12"
                >
                  −
                </button>

                <span className="flex h-full w-11 items-center justify-center text-sm text-gray-700 sm:w-12">
                  {quantity}
                </span>
            ...
            <div className="mb-7 grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 rounded-xl border border-gray-300 py-3 text-xs font-medium transition hover:border-gray-500 disabled:opacity-50 sm:text-sm"
              >
                <Heart
                  size={18}
                  fill={
              ...
              <button
                type="button"
                onClick={handleShare}
                className="flex items-center justify-center gap-2 rounded-xl border border-gray-300 py-3 text-xs font-medium transition hover:border-gray-500 sm:text-sm"
              >
                <Share2 size={18} />
                SHARE
              </button>
        ...
        {/* Related Products */}
        <section className="mt-12 border-t border-gray-100 pt-10 sm:mt-16 sm:pt-14">
          <h2 className="mb-6 text-center text-xl font-bold text-gray-900 sm:mb-8 sm:text-3xl">
            Related Products
          </h2>
      ...
      {showNotification && (
        <div
          className={`fixed inset-x-4 bottom-4 z-50 rounded-xl px-4 py-3 text-center text-sm font-medium text-white shadow-lg sm:inset-x-auto sm:right-5 sm:w-auto ${notificationType === 'success'
            ? 'bg-green-500'
            : 'bg-red-500'
            }`}
